...
#scales_pascal = [0.03, 0.07, 0.15, 0.3, 0.5, 0.7, 0.9, 1.05]#SSD500 change001
scales_pascal = [0.01, 0.03, 0.07, 0.2, 0.35, 0.55, 0.8, 1.05]#SSD500 change002
...
model_checkpoint = ModelCheckpoint(filepath='D:/Data/Python/deeplearning/SSD/ssd_keras-master/path/to/ssd500test_from_conv1_1_changeanchors002.h5',
                                   monitor='val_loss',
                                   verbose=1,
                                   save_best_only=True,
